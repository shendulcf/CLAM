...
from datasets.dataset_generic_myself import Generic_WSI_Classification_Dataset, Generic_MIL_Dataset, save_splits
import h5py
from utils.eval_utils_myself import *

# Training settings
parser = argparse.ArgumentParser(description='CLAM Evaluation Script')
parser.add_argument('--data_low_dir', type=str, default=None, 
                    help='data directory to low level slide')
parser.add_argument('--data_high_dir',type = str, default=None,
                    help='data directory to low level slide')
...
if args.task == 'task_1_tumor_vs_normal':
    args.n_classes=2
    dataset = Generic_MIL_Dataset(csv_path = '/home/sci/Disk2/tcga_crc/RESULTS_DIRECTORY_5/step3_get_splits.csv',
    ...
    dataset = Generic_MIL_Dataset(csv_path = args.csv_path,
                            ...
                            data_low_dir= args.data_low_dir,
                            data_high_dir= args.data_high_dir,
                            shuffle = False, 
                            print_info = True,
