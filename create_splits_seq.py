...
if args.task == 'task_1_tumor_vs_normal':
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = '/home/sci/Disk2/tcga_brca/RESULTS_DIRECTORY/step_3.csv',  #  修改了路径 dataset_csv/tumor_vs_normal_dummy_clean.csv
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
